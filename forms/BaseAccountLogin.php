 ...
 */
class BaseAccountLogin extends Model
{
    ...
    {
        if ($this->_user === false) {
            $this->_user = User::find()->where(['username' => $this->username])->orWhere(['email' => $this->username])->orWhere(['secondary_email' => $this->username])->one();
