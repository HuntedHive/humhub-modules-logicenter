    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="owl-carousel owl-carousel-registration">
                ...
                <div class="row">
                    ...
                    <div class="item">
                        ...
                        <div class="row">
                            	<div class="form-group col-sm-8 col-sm-offset-2">
                                    <select name="teacherlevel" class="selectpicker form-control show-tick" title="Select teacher level * ..." required>
                                        <optgroup label="Select teacher level">
                                          <option value="pre-service">pre-service</option>
                                          <option value="early career teacher">early career teacher</option>
                                          <option value="experienced teacher">experienced teacher</option>
                                          <option value="mentor teacher">mentor teacher</option>
                                          <option value="other">other</option>
                                        </optgroup>
                                    </select>
                                </div>
                                <div id="teacherlevel-other" class="hidden">
                                    <div class="form-group col-xs-2 col-sm-1 col-sm-offset-2 indent-other">
                                        <i class="fa fa-arrow-right"></i>
                                    </div>
                                    <div class="form-group col-xs-10 col-sm-7">
                                        <input class="form-control" id="teacherlevel-other" placeholder="Enter 'other' teacher level *" name="teacherLevelOther" type="text" required>
                                    </div>
                                </div>
                                <div class="form-group col-sm-8 col-sm-offset-2">
                                ...
                                <div id="teachertype-other" class="hidden">
                                    <div class="form-group col-xs-2 col-sm-1 col-sm-offset-2 indent-other">
                                        <i class="fa fa-arrow-right"></i>
                                    </div>
                                    <div class="form-group col-xs-10 col-sm-7">
                                ...
                                <div class="form-group col-sm-8 col-sm-offset-2">
                                    <select name="subjectarea" class="selectpicker form-control show-tick" multiple title="Select subject area(s)...">
                                        <optgroup label="Select subject area(s)">
                                ...
                                <div id="subjectarea-other" class="hidden">
                                    <div class="form-group col-xs-2 col-sm-1 col-sm-offset-2 indent-other">
                                        <i class="fa fa-arrow-right"></i>
                                    </div>
                                    <div class="form-group col-xs-10 col-sm-7">
                                        <input class="form-control" id="subjectarea-other" placeholder="Enter 'other' subject area *" name="subjectAreaOther" type="text" required>
                                    </div>
                                </div>
                                <div class="form-group col-sm-8 col-sm-offset-2">
                                    <select name="teachinginterests" class="selectpicker form-control show-tick" required title="Select teaching interests...">
                                      <optgroup label="Select teaching interests">
                                ...
                                <div id="teachinginterests-other" class="hidden">
                                    <div class="form-group col-xs-2 col-sm-1 col-sm-offset-2 indent-other">
                                        <i class="fa fa-arrow-right"></i>
                                    </div>
                                    <div class="form-group col-xs-10 col-sm-7">
                                        <input class="form-control" id="teachinginterests-other" placeholder="Enter 'other' teacher interests *" name="teachingInterestsOther" type="text" required>
                                    </div>
                                </div>
                        </div>
...
<script type="text/javascript">
	...
	$('.owl-carousel-registration').owlCarousel({
	  loop: false,
	  items: 1,
	  margin:15,
	  nav:true,
